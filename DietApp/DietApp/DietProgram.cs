...
namespace DietApp
{
    public class DietProgram
    {
        ...
        public double desired_wheight { get; }
        public int weeks_of_dieting { get; }
        public int hours_of_sleep { get; }
        public int hours_of_excersise { get; }

        DietProgram(string patient_id, string type_of_diet, string reason_to_diet, double desired_wheight, int weeks_of_dieting, int hours_of_sleep, int hours_of_excersise)
        {
            this.patient_id = patient_id;
            this.type_of_diet = type_of_diet;
            this.reason_to_diet = reason_to_diet;
            this.desired_wheight = desired_wheight;
